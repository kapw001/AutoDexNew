        ...
        switch (requestCode) {
            case MLTIPLE_PERMISSION_REQUEST:
                ...
                if (RuntimePermissionRequest.verifyPermissions(grantResults)) {
                    ...
                    Toast.makeText(this, "Please allow contact and location permission to proceed ", Toast.LENGTH_SHORT).show();
//                    Utility.showDialog(LoginActivity.this, "Permission", "Please allow contact and location permission to proceed ");
    ...
    private void listener() {
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (RuntimePermissionRequest.checkMultiplePermission(LoginActivity.this, permission)) {

                    RuntimePermissionRequest.requestPermissionMultiple(LoginActivity.this, permission, MLTIPLE_PERMISSION_REQUEST, "Permission", "Please allow contact and location permission to proceed ");
                } else {
                    callLogin();
                }
...
//            Utility.hideProgress();
            ...
            Utility.showProgress(LoginActivity.this, "Loading");
...
//            }
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        if (error.networkResponse.statusCode == 400 || error.networkResponse.statusCode == 401) {
            Utility.showDialog(LoginActivity.this, "Error", "Mobile number and Password is incorrect.");
        } else if (error.networkResponse.statusCode == 422) {

            Utility.showDialog(LoginActivity.this, "Error", "This account is inactive. Would you like to activate your account.", new Utility.DialogButtonListener() {
                @Override
                public void ok() {


                    Utility.showProgress(LoginActivity.this, "Loading");
                    webPostRequest.postGETDataOTP(WebUrl.GENERATEOTP + "/" + phonenumber.getText().toString(), "", new WebResponse() {
                        @Override
                        public void onResponse(JSONObject response) {
                            Utility.hideProgress();
                        }
                        ...
                        public void onResponse(String response) {
                            ...
                            Utility.hideProgress();
                            startActivity(new Intent(getApplicationContext(), OTPValidation.class).putExtra("number", phonenumber.getText().toString()).putExtra("signup", true));
                            finish();
                        }
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Utility.hideProgress();
                            Log.e(TAG, "onErrorResponse: " + error.getMessage());
                            Utility.showDialog(LoginActivity.this, "Error", getResources().getString(R.string.e));
                        }
            ...
            Utility.showDialog(LoginActivity.this, "Error", "Server error, try again");
        }
